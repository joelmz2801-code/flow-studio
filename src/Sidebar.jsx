    ...
    return (
      <aside className="sidebar collapsed">
        ...
        <button className="icon-btn" onClick={() => openSettings('api')} title="API 设置">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 7h7v7"/><path d="M21 7l-9 9"/><path d="M3 17v-4a4 4 0 0 1 4-4h7" strokeLinecap="round"/></svg>
        </button>
      </aside>
    )
  }
